...
public class Play extends BasicGameState {
	...
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {// tiledmap
		music = new Music("sounds/bgm1.wav");
		...
		SpriteSheet idleLeft = new SpriteSheet("res/" + job + "/attack/idleLeft.png", 180, 170);
		SpriteSheet idleRight = new SpriteSheet("res/" + job + "/attack/idleRight.png", 180, 170);
		SpriteSheet attackLeft = new SpriteSheet("res/" + job + "/attack/attackLeft.png", 180, 170);
		SpriteSheet attackRight = new SpriteSheet("res/" + job + "/attack/attackRight.png", 180, 170);
		SpriteSheet battleMoveLeft = new SpriteSheet("res/" + job + "/attack/runLeft.png", 200, 170);
		SpriteSheet battleMoveRight = new SpriteSheet("res/" + job + "/attack/runRight.png", 200, 170);
